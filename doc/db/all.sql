...
insert into test (id, name, password) values (1, '测试', 'passwalrd');
...
insert into ebook (id, name, description) values (5, 'MySQL 入门教程', '零基础入门 MySQL 开发，企业级应用开发最佳首选框架');
...
insert into category (id, parent, name, sort) values (100, 100, '前端开发', 100);
